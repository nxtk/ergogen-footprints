...
Params:
  ...
  reversible: default is false
    if true, the footprint will be placed on both sides so that the PCB can be reversible
  ...
  model_{socket,plug}_filename: defaults are below
    ...
    socket - 'battery_connector_jstph2_socket.step'
      plug - 'battery_connector_jstph2_plug.step'
...
module.exports = {
  params: {
    ...
    model_plug_filename: 'battery_connector_jstph2_plug.step',
